...
const OldSowingGapAnalysis = () => {
  ...
  return (
    <Box p={3} sx={{ bgcolor: "#f5f5f5", minHeight: "100vh" }}>
      ...
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
        ...
        <Box display="flex" gap={1}>
          <Button
            ...
            to="/u/sowing-gap-analysis"
            sx={{ textTransform: "none", fontWeight: 600 }}
          >
            New inventory requests
          </Button>
          <Button
            variant="contained"
            color="success"
      ...
      {/* Today's Sowing Cards Section — legacy prompt-based requests */}
...
export default OldSowingGapAnalysis;
